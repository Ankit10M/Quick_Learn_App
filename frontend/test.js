export const navbarStyles = {
  // Main nav container
  nav: "w-full h-[6rem] bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 shadow-2xl py-3 sm:py-4 px-4 sm:px-6 lg:px-10 relative flex items-center justify-between overflow-visible",
  ...
  // Main container
  container: "w-full flex items-center justify-between relative z-10 h-full px-4 sm:px-8",
  
  // Logo section
  logoContainer: "flex items-center h-full ",
  ...
  // Title section
  titleContainer: "h-full flex-1 flex justify-center item-center text-center w-[25rem]",
  titleBackground: "bg-gradient-to-r from-blue-600/25 via-purple-600/25 to-indigo-600/25 xl:ml-30 backdrop-blur-sm px-4 py-2 sm:px-6 sm:py-3 rounded-full border border-white/10 shadow-md w-[18rem] ",
  ...
  // Desktop buttons
  desktopButtonsContainer:"hidden md:flex items-center justify-end pr-2 cursor-pointer gap-4 h-full",
